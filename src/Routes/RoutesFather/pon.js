...
import PagResult7 from './pag_result7'
...
function Passo02({register}) {
    ...
    const PageDisplay = () => {
        console.log(cont)       
        if(cont == "prox")return <PagResult7 register={register} />;
        if(cont == "ante")return <PagResult6 register={register} />;
